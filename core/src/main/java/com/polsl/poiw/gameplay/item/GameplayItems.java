...
public final class GameplayItems {
    ...
    public static final ItemDefinition GOLD_BAR = simpleItem(
        ...
        ItemType.VALUABLE,
        "Sztabka zlota",
        "Sztabka zlota o wysokiej wartosci.",
        "gold/item_gold_bar",
    ...
    public static final ItemDefinition CHICKEN_RAW = simpleItem(
        ...
        ItemType.MATERIAL,
        "Surowy kurczak",
        "Mieso drobiowe do dalszej obrobki.",
        "food/chicken_raw",
